...
import com.atm.dao.CheckbookDao;
import com.atm.model.Account;
import com.atm.model.Checkbook;
import com.atm.model.Customer;
import com.atm.utility.Constants.CheckbookStatus;
...
public class AccountController {
	...
	public String goToChangePinPage() {
		return "changepin";
	}

	@PostMapping("/changepin")
	public ModelAndView changePin(@RequestParam("currentpin") int currentPin, @RequestParam("newpin") int newPin,
			HttpSession session) {
		ModelAndView mv = new ModelAndView();
	...
	public ModelAndView changeAccountStatus(@RequestParam("accountId") int accountId,
	...
	public ModelAndView updateCheckbookStatus(@RequestParam("customerId") int customerId,
