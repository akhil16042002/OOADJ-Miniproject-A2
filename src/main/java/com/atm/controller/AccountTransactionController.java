...
import com.atm.dao.AccountTransactionDao;
import com.atm.model.Account;
import com.atm.model.AccountTransaction;
import com.atm.model.Customer;
import com.atm.utility.Constants.AccountStatus;
import com.atm.utility.Constants.TransactionType;
...
public class AccountTransactionController {
	...
	public ModelAndView withdraw(@RequestParam("amount") double amount, @RequestParam("pin") int pin,
			HttpSession session) {
	...
	@PostMapping("/deposit")
	public ModelAndView deposit(@RequestParam("amount") double amount, @RequestParam("pin") int pin,
			HttpSession session) {
	...
	public ModelAndView accountTransfer(@RequestParam("toCardNo") String toCardNo,
			@RequestParam("amount") double amount, @RequestParam("pin") int pin, HttpSession session) {
